	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
			...
			if(bookId.isEmpty() || borrowerId.isEmpty()){
				...
				if(ls.issueBook(ls, book, borrowerId)){
					rs = db.dbBookRetrieve(bookId, "", "");
					jTable1 = new javax.swing.JTable(buildTableModel(rs));
					jScrollPane1.setViewportView(jTable1);
					JOptionPane.showMessageDialog(null, "Book has been issued successfully", "LMS", JOptionPane.INFORMATION_MESSAGE);
				}else{
					JOptionPane.showMessageDialog(null, "Unable to issue book", "LMS", JOptionPane.INFORMATION_MESSAGE);
				}
